...
struct MeasurementFormView: View {
    ...
    private func saveMeasurement() {
        ...
        newMeasurement.bodyWeight = parseDecimal(bodyWeight)
        newMeasurement.bodyFat = parseDecimal(bodyFat)
        newMeasurement.neck = parseDecimal(neck)
        newMeasurement.shoulders = parseDecimal(shoulders)
        newMeasurement.chest = parseDecimal(chest)
        newMeasurement.waist = parseDecimal(waist)
        newMeasurement.hips = parseDecimal(hips)
        newMeasurement.armLeft = parseDecimal(armLeft)
        newMeasurement.armRight = parseDecimal(armRight)
        newMeasurement.forearmLeft = parseDecimal(forearmLeft)
        newMeasurement.forearmRight = parseDecimal(forearmRight)
        newMeasurement.thighLeft = parseDecimal(thighLeft)
        newMeasurement.thighRight = parseDecimal(thighRight)
        newMeasurement.calfLeft = parseDecimal(calfLeft)
        newMeasurement.calfRight = parseDecimal(calfRight)
